...
// Function to calculate distance between two coordinates (in meters)
  ...
  //     String passengerId =
  //         passenger['userId']; // Unique identifier for each passenger
  ...
  //     onTap: rideStatus.toUpperCase() == "COMPLETED" ? null : () {
  //     print("PResssseeedd");
  //       Navigator.push(
  //         context,
  //         MaterialPageRoute(
  ...
  Widget _buildBookedRideCard(Map<String, dynamic> rideData, String rideId) {
    ...
    //
    //   // Update the ride document in Firestore
    //   await FirebaseFirestore.instance.collection('rides').doc(rideId).update({
    //     'passengers': FieldValue.arrayRemove([passengers[passengerIndex]]),
    //     // Assuming there is a field called 'availableSeats' to update
    //     'availableSeats': FieldValue.increment(seatsToReturn),
    //   });
    //
    //   // Remove the ride from the user's booked rides array
...
''';
    ...
    //
    //   // Update the local passengers list
    //   var passengerToRemove = passengers.removeAt(passengerIndex);
    //
