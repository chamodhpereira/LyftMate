...
//           //         ),
//           //       ),
//           //       child: const Text('Update Route', style: TextStyle(fontSize: 16)),
//           //     ),
//           //   ),
//           // ),
//           Positioned(
...
//
//             Text("Route Options"),
//             // Add checkboxes for route options
//             CheckboxListTile(
//               title: const Text('Avoid Highways'),
//               value: avoidHighways,
//               onChanged: (bool? value) {
...
//             ElevatedButton(
//               onPressed: () {
//                 // Collect waypoints into a list while filtering out null values
//                 List<LatLng> waypoints = [];
//                 if (waypoint1 != null) waypoints.add(waypoint1!);
//                 if (waypoint2 != null) waypoints.add(waypoint2!);
//
//                 // Pass the selected waypoints and route options back to the main page
//                 Navigator.pop(context, {
//                   'waypoints': waypoints,
//                   'avoidHighways': avoidHighways,
//                   'avoidTolls': avoidTolls,
...
//           ),
//           onTap: () async {
//             // Navigate to SelectWaypointsScreen and wait for a result
//             final Map<String, dynamic>? waypointData = await Navigator.push(
//               context,
//               MaterialPageRoute(
//                 builder: (context) => SelectWaypointsScreen(waypointLabel: label),
