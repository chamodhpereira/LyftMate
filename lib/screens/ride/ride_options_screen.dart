...
class _RideOptionsState extends State<RideOptions> {
  ...
  Future<void> _publishRide() async {
    ...
    bool areAllFieldsFilled = _selectedLuggageOption != 'Select Luggage' &&
        _selectedPaymentOption != 'Select Payment' &&
        _selectedApprovalOption != 'Select Approval' &&
        _selectedPreferences.isNotEmpty &&
        _pricePerSeatController.text.isNotEmpty;

    if (!areAllFieldsFilled) {
      // Not all fields are filled, show an error message
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('All fields are required. Notes are optional.'),
